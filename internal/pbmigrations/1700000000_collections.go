...
func init() {
	migrations.Register(func(app core.App) error {
		...
		servers.Fields.Add(&core.TextField{Name: "backend_user_agent", Max: 255})
		servers.Fields.Add(&core.TextField{Name: "backend_authorization_client", Max: 255})
		servers.Fields.Add(&core.TextField{Name: "backend_authorization_device", Max: 255})
		servers.Fields.Add(&core.TextField{Name: "backend_authorization_device_id", Max: 255})
		servers.Fields.Add(&core.TextField{Name: "backend_authorization_version", Max: 80})
		...
		sessions.Fields.Add(&core.TextField{Name: "backend_user_agent", Max: 255})
		sessions.Fields.Add(&core.TextField{Name: "backend_authorization_client", Max: 255})
		sessions.Fields.Add(&core.TextField{Name: "backend_authorization_device", Max: 255})
		sessions.Fields.Add(&core.TextField{Name: "backend_authorization_device_id", Max: 255})
		sessions.Fields.Add(&core.TextField{Name: "backend_authorization_version", Max: 80})
