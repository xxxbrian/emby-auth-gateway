...
func init() {
	migrations.Register(func(app core.App) error {
		...
		servers.Fields.Add(&core.TextField{Name: "backend_user_agent", Required: true, Max: 255})
		servers.Fields.Add(&core.TextField{Name: "backend_authorization_client", Required: true, Max: 255})
		servers.Fields.Add(&core.TextField{Name: "backend_authorization_device", Required: true, Max: 255})
		servers.Fields.Add(&core.TextField{Name: "backend_authorization_device_id", Required: true, Max: 255})
		servers.Fields.Add(&core.TextField{Name: "backend_authorization_version", Required: true, Max: 80})
		...
		accounts.Fields.Add(&core.TextField{Name: "backend_password", Required: true})
		...
		sessions.Fields.Add(&core.TextField{Name: "backend_user_agent", Required: true, Max: 255})
		sessions.Fields.Add(&core.TextField{Name: "backend_authorization_client", Required: true, Max: 255})
		sessions.Fields.Add(&core.TextField{Name: "backend_authorization_device", Required: true, Max: 255})
		sessions.Fields.Add(&core.TextField{Name: "backend_authorization_device_id", Required: true, Max: 255})
		sessions.Fields.Add(&core.TextField{Name: "backend_authorization_version", Required: true, Max: 80})
