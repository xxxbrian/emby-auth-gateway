// A deterministic Emby-compatible upstream for native Web conversion tests.
...
func main() {
	...
	durationSeconds := flag.Int("duration", 360, "duration of generated test media")
	flag.Parse()
	if *dir == "" {
	...
	media := map[string]any{"Id": "fixture-source", "Name": "Audio compatibility sample", "Container": "mkv", "Protocol": "File", "Path": "/fixture/source.mkv", "Size": size, "Bitrate": bitrate, "RunTimeTicks": int64(duration * 1e7), "SupportsDirectPlay": true, "SupportsDirectStream": true, "SupportsTranscoding": false, "DefaultAudioStreamIndex": defaultAudio, "DirectStreamUrl": base + "/Videos/fixture/original.mkv?MediaSourceId=fixture-source&Static=true&api_key=fixture-token", "MediaStreams": streams}
	item := map[string]any{"Id": "fixture", "ServerId": "fixture-server", "Name": "Audio compatibility fixture", "Type": "Movie", "MediaType": "Video", "IsFolder": false, "RunTimeTicks": int64(duration * 1e7), "MediaSources": []any{media}, "MediaStreams": streams, "MediaSourceCount": 1, "Container": "mkv", "Overview": "Locally generated audio compatibility test. Two audio tracks exercise conversion and switching.", "ProductionYear": 2026, "LocationType": "FileSystem", "UserData": map[string]any{"Played": false, "PlaybackPositionTicks": 0, "IsFavorite": false, "PlayCount": 0}, "People": []any{}, "Genres": []string{"Test"}, "Studios": []any{}, "Chapters": []any{map[string]any{"StartPositionTicks": 0, "Name": "Start"}, map[string]any{"StartPositionTicks": 60 * 1e7, "Name": "One minute"}}}
	...
	handler := http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case path == "/System/Info/Public" || path == "/System/Info":
			write(w, map[string]any{"Id": "fixture-server", "ServerName": "Local audio test", "Version": "4.9.5.0", "LocalAddress": base, "WanAddress": base})
